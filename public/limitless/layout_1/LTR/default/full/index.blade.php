			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
						<img src="{{ asset('limitless/global_assets/images/placeholders/placeholder.jpg')}}" class="rounded-circle" alt="">
						<span>Victoria</span>
					</a>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/facebook.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/youtube.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/spotify.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/twitter.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/bing.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/amazon.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/brands/dribbble.png')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
														<a href="#">
															<img src="{{ asset('limitless/global_assets/images/placeholders/placeholder.jpg')}}" class="rounded-circle" width="32" height="32" alt="">
														</a>
													</div>
													<div>
										...
										<div class="media flex-column flex-sm-row mt-0 mb-3">
				        					<div class="mr-sm-3 mb-2 mb-sm-0">
												<div class="card-img-actions">
													<a href="#">
														<img src="{{ asset('limitless/global_assets/images/placeholders/placeholder.jpg')}}" class="img-fluid img-preview rounded" alt="">
							...
							<div class="tab-content card-body">
								<div class="tab-pane active fade show" id="messages-tue">
									<ul class="media-list">
										<li class="media">
											<div class="mr-3 position-relative">
												<img src="{{ asset('limitless/global_assets/images/placeholders/placeholder.jpg')}}" class="rounded-circle" width="36" height="36" alt="">
